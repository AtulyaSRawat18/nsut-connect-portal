...
export default async function OpportunitiesPage({ searchParams }: { searchParams?: Promise<{ q?: string; type?: string; deadline?: string; department?: string; page?: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-background py-16 font-sans">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <form className="mb-12 grid gap-3 rounded-2xl border border-outline bg-surface p-4 xl:grid-cols-[1fr_10rem_11rem_16rem_auto]">
