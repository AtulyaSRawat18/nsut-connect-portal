...
export function StudentProjectAction({ projectId, availableSeats, isClosed }: { projectId: string; availableSeats: number; isClosed: boolean }) {
  ...
  return <ApplyProjectButton projectId={projectId} availableSeats={availableSeats} isClosed={false} />;
}
