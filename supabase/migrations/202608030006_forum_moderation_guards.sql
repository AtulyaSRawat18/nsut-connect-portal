...
drop policy if exists "Active members reply to visible posts" on public.forum_replies;
...
drop policy if exists "Active members vote on visible posts" on public.forum_post_votes;
...
drop policy if exists "Members update votes on visible posts" on public.forum_post_votes;
...
drop policy if exists "Active members vote on visible replies" on public.forum_reply_votes;
...
drop policy if exists "Members update votes on visible replies" on public.forum_reply_votes;
